...
fun SaleLazyRowItem(
    ...
    var isCard by mutableStateOf(false)
    ...
    Card(
        ...
        Box(
            ...
            AsyncImage(
                model = itemProduct.images?.get(0), contentDescription = "", modifier = Modifier
            ...
            Icon(
                imageVector = if (!isFavorite) ImageVector.vectorResource(id = R.drawable.group_160) else
                    ImageVector.vectorResource(id = R.drawable.group_160_red),
                contentDescription = "",
                tint = Color.Unspecified,
                modifier = Modifier
            ...
            Icon(
                ...
                tint = Color.Unspecified,
                modifier = Modifier
                    .padding(start = 135.dp, top = 179.dp)
                    .clickable {
                        mainScreenViewModel.getProductByID(itemProduct.id ?: 0) {
                            if ((it == null)) {
                                mainScreenViewModel.insertProductToDataBase(
